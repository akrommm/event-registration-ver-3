    ...
    <div class="container mt-5">
        <div class="card shadow-lg" style="margin: auto; border-radius: 10px;">
            <div class="card-body text-center">
                ...
                <div class="text-center mt-4">
                    <a href="{{ url('admin/manage-idcard') }}" class="btn btn-primary btn-lg px-10 shadow-sm" style="transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';" style="border-radius: 10px;">
